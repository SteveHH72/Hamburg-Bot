...
class Ping(discord.ui.View):
    ...
    @discord.ui.button(
        label="Remove Reaction", style=discord.ButtonStyle.blurple, emoji="🔕")
    async def pings(self, button: discord.ui.Button, interaction: discord.Interaction):
        await interaction.response.send_message("You don't have any more the Role 'Notification'", ephemeral=True)
