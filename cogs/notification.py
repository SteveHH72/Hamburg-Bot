...
guild_id_slash = 893947040869019708

reaction_roles_data = {}
"""Angelehnt an 'https://gist.github.com/makupi/c508c9d33bb01dcc04e57d1a93c23ae1#file-reactionroles-discord-py'"""
try:
...
class Notification(commands.Cog):
    ...
    @slash_command(guild_ids=[guild_id_slash])
    async def reaction(
            self,
            ctx,
            emote,
